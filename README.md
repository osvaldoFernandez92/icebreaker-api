...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/icebreaker-api?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Build Status](https://travis-ci.org/Wolox/icebreaker-api.svg?branch=master)](https://travis-ci.org/Wolox/icebreaker-api)
[![Code Climate](https://codeclimate.com/github/Wolox/icebreaker-api/badges/gpa.svg)](https://codeclimate.com/github/Wolox/icebreaker-api)
...
- Clone the repository by running `git clone git@github.com:Wolox/icebreaker-api.git`
- Go to the project root by running `cd icebreaker-api`
...
```bash
  ...
  CREATE ROLE "icebreaker-api" LOGIN CREATEDB PASSWORD 'icebreaker-api';
```
